...
Boxi Cone::getBox() {
    Boxi boxi;
    boxi.vMin = MathFuncs::vector3FloorOrCeil(m_vCenter - Vector3(m_fRadius, 0, m_fRadius), true);
    boxi.vMax = MathFuncs::vector3FloorOrCeil(m_vCenter + Vector3(m_fRadius, m_fHeight, m_fRadius), false);
    return boxi;
}
