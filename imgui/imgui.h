...
namespace ImGui
{
    ...
    // custom widgets
    IMGUI_API bool          ImageTextButton(const char* id, ImTextureID user_texture_id, const ImVec4& back_color, ImGuiColorEditFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
